  ...
  switch (kind) {
    case 'eligible':
      return {
        ...
        body: 'Your SignMaster purchase has been verified. Next, create an account or sign in to activate access and save your progress.',
        showOrderId: true,
    ...
    case 'not_found':
      return {
        ...
        body: 'Check the digits, and make sure it is the Amazon order containing your SignMaster flashcards. If you placed your order very recently, it may take a little while to appear — please try again later.',
        showOrderId: true,
    ...
    case 'not_shipped':
      return {
        ...
        body: 'App access will be available once Amazon dispatches your order. Please try again after dispatch.',
        showOrderId: true,
    ...
    case 'already_claimed':
      return {
        ...
        body: 'A SignMaster account has already been activated with this order. Sign in to that account to carry on where you left off.',
        showOrderId: true,
    ...
    case 'returned':
      return {
        ...
        body: "It looks like the SignMaster pack from this order was returned, so this order can't be used to activate app access. If that's not right, get in touch.",
        showOrderId: true,
        primaryLabel: 'Try another Order ID',
        secondaryLabel: 'Get support',
        secondaryKind: 'support',
    ...
    case 'rate_limited':
      return {
        ...
        body: "We've had several verification attempts. Please wait a few minutes before trying again. If you still need help, contact support.",
        showOrderId: true,
        primaryLabel: 'Check again',
        secondaryLabel: 'Get support',
        secondaryKind: 'support',
    ...
    case 'service_unavailable':
      return {
        ...
        body: 'SignMaster is temporarily unavailable. Your order number has been kept. Please try again in a few minutes.',
        showOrderId: true,
    ...
    case 'connection_error':
      return {
        ...
        body: 'Check your internet connection and try again. Your order number has been kept.',
        showOrderId: true,
        primaryLabel: 'Try again',
        secondaryLabel: 'Get support',
        secondaryKind: 'support',
